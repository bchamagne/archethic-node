defmodule Archethic.Contracts.Interpreter.ConditionValidatorTest do
  ...
  describe "execute_condition/2" do
    test "should return Accepted if the transaction's conditions are valid" do
      code = ~s"""
    ...
    test "should return Accepted if the inherit's conditions are valid" do
      code = ~s"""
      condition inherit: [
        content: "Hello"
      ]
    ...
    test "should return Accepted if the oracle's conditions are valid" do
      code = ~s"""
    ...
    test "should return Accepted with a flexible condition" do
      code = ~s"""
      condition inherit: [
        content: true
      ]
    ...
    test "should return Rejected if modifying a value not in the condition" do
      code = ~s"""
      condition inherit: []
      """
